...
public class SegmentControl extends View {
    ...
    private com.sevenheaven.segmentcontrol.RadiusDrawable mBackgroundDrawable;
    private com.sevenheaven.segmentcontrol.RadiusDrawable mSelectedDrawable;
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBackgroundDrawable = new com.sevenheaven.segmentcontrol.RadiusDrawable(mCornerRadius, true);
